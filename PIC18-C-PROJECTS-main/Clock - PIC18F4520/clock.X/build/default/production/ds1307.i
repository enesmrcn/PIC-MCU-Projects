...
extern void I2C_Initialize(const unsigned long feq_K);
...
void Set_Time_Date()
{
   ...
   I2C_Write((0xD0));
   I2C_Write(0);
   I2C_Write(DEC_2_BCD(set_time.sec));
   I2C_Write(DEC_2_BCD(set_time.min));
   I2C_Write(DEC_2_BCD(set_time.hour));
   I2C_Write(1);
   I2C_Write(DEC_2_BCD(set_time.date));
   I2C_Write(DEC_2_BCD(set_time.month));
   I2C_Write(DEC_2_BCD(set_time.year));
   I2C_End();
}
...
void Update_Current_Date_Time()
{
   ...
   current_time.min = BCD_2_DEC(I2C_Read(1));
