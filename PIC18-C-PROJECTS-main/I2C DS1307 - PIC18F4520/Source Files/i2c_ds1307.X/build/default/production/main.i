...
void UART_Init(const uint32_t baudrate)
{
 ...
 uint16_t baudrate_calculated = (20000000 - baudrate * 4) /(baudrate * 4);
...
void Set_Time_Date()
{
   ...
   I2C_Write((0xD0));
   I2C_Write(0);
   I2C_Write(DEC_2_BCD(00));
   I2C_Write(DEC_2_BCD(14));
   I2C_Write(DEC_2_BCD(15));
   I2C_Write(1);
   I2C_Write(DEC_2_BCD(17));
   I2C_Write(DEC_2_BCD(10));
   I2C_Write(DEC_2_BCD(21));
   I2C_End();
}
