...
uint8_t led = 0;
uint32_t numb = 0xFFFEFDFC;

int8_t EEPROMwrite(uint32_t * ptr, uint8_t byte, uint8_t address)
{
...
# 113 "main.c"
    ...
    while (1)
    {
        ...
        LATD = EEPROMread(0x01);
        _delay((unsigned long)((2000)*(10000000/4000.0)));

        LATD = EEPROMread(0x02);
        _delay((unsigned long)((2000)*(10000000/4000.0)));

        LATD = EEPROMread(0x03);
        _delay((unsigned long)((2000)*(10000000/4000.0)));
