...
void UART_RC_IntEnable(const uint8_t priority);
void INTx_Init();
void TMR0_Run(void);
...
void TMR0_Init(uint16_t delay_ms)
{
    ...
    uint16_t n = (10000000 / 102.0 ) * delay_ms / 10000.0;
...
void UART_Init(const uint32_t baudrate)
{
 ...
 uint16_t baudrate_calculated = (10000000 - baudrate * 4) / (baudrate * 4);
