...
;---------------------------------------------------------------------- 
; Note 3 :
;   In the line 84, it program flow will change. The program will go to
;   START label whenever it sees the command "GOTO START"
;   Very simple! So, we got continuous digital reading on the ports
;
;----------------------------------------------------------------------
